...
class BLOCKCHAIN:
    def __init__(self):
        ...
        self.nodes = set()
    # writing the function for creating the genesis block
    ...
    def validateChain(self, chain):
        ...
        while blockIndex < len(chain):
            ...
            blockIndex += 1
        return True
    # Adding the transactions function
    ...
    # coding the replace chain function that follows the proof of consensus
...
def mine_block():
    ...
    BLOCKCHAIN.addTransaction(sender = node_address, receiver = 'Harshith', amount = 1)
    response = {
